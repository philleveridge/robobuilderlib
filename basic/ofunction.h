...
extern tOBJ omax(tOBJ  r);
extern tOBJ omat(tOBJ  r);
extern tOBJ otrn(tOBJ  r);
extern tOBJ oapply(tOBJ  r);
extern tOBJ orshp(tOBJ  r);
extern tOBJ orep(tOBJ  r);
extern tOBJ ozero(tOBJ  r);
extern tOBJ ominv(tOBJ  r);
extern tOBJ oeye(tOBJ  r);
extern tOBJ ovsum(tOBJ  r);
extern tOBJ ohsum(tOBJ  r);
extern tOBJ ovsum2(tOBJ  r);
extern tOBJ ohsum2(tOBJ  r);
extern tOBJ oconv(tOBJ  r);
extern tOBJ oimp(tOBJ  r);
extern tOBJ ocond(tOBJ  r);
extern tOBJ ozerob(tOBJ  r);
...
extern tOBJ orex(tOBJ  r); 
extern tOBJ olft(tOBJ  r); 
extern tOBJ orgt(tOBJ  r); 
extern tOBJ omid(tOBJ  r); 
